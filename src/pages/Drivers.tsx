    ...
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Drivers assigned to your restaurant via Super Admin ({drivers.length} driver{drivers.length === 1 ? "" : "s"})
        </p>
      </div>
      ...
      <p className="text-xs text-muted-foreground flex items-center gap-2">
        ...
        Driver profiles are managed by the Driver App. Assignments are controlled in Super Admin.
      </p>
    </div>
  );
};
